...
%o`, message, error2, detail);
  ...
  var MAX_ADJACENT = 10;
  var MIN_DISTANT = 11;
  var NUMBERS = Object.keys(DATA).map((key) => +key);
  var MAX_DISTANT = Math.floor(NUMBERS.length / 2);
  ...
  var counting_controller_default = class extends Controller {
    ...
    handleSuccess(newNumber) {
      ...
      this.currentNumberWordTarget.textContent = DATA[this.currentNumber];
  ...
  counting_controller_default.targets = [
    "currentNumber",
    "currentNumberWord",
    "message",
    "numberOption",
